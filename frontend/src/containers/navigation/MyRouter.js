...
import ProjectReadContainer from '../ProjectReadContainer';
  ...
  return (
    ...
    <Router>
      <Switch>
        ...
        <Route path="/projects/:project_id/read" component={ProjectReadContainer} />
        <Route path="/projects/:project_id/edit" component={EditProjectContainer} />
        <Route path="/projects/:project_id/delete" component={ProjectDeleteContainer} />
